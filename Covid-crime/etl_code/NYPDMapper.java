...
public class NYPDMapper extends Mapper<LongWritable, Text, Text, Text> {
 private static final int MISSING = 9999;
 static ArrayList<String> checking = new ArrayList<String>(Arrays.asList("3","4","5","6","7","8","9","10"));
  ...
  if(date.size() > 2){
    try{
     ...
     if(!mont.equals("02")&&!mont.equals("01")&&!mont.equals("11")&& !mont.equals("10")){//checking.contains(mont)){
         context.write(new Text(mont), new Text("arrest:1"));
     }
    }
    catch(Exception e){}
  }
